# Tienda Auris - Partituras
Este es un proyecto realizado para el curso de REACT JS de Coderhouse. La aplicación permite ver productos a la venta y realizar una compra. Los datos de productos y órdenes se almacenan en Firebase
